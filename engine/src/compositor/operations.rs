...
pub trait Operation: Any {
    ...
    /// only operations meant to be picked as an animation target's
    /// output source need to override this. Purely cosmetic - nothing
    /// in the engine depends on these strings, they only reach the UI.
